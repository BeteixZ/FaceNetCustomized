...
def Recognize():
    ...
    # Load Face Data
    features, labels = loadFaceData("C:/Users/Bill Kerman/PycharmProjects/FaceNetCustomized/database/BetaFeature/",
                                    device)

    cap = cv.VideoCapture('C:\\Users\\Bill Kerman\\PycharmProjects\\FaceNetPyTorch\\20200804人脸检测+人脸识别_测试视频\\room_b~1 00_01_48-00_02_06.mp4')
    flag = cap.isOpened()
